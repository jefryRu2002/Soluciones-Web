...
export class OrdenesAsignadas {
  ...
  ordenes = signal<Orden[]>([
    ...
    { ticket: 'TK-002', cliente: 'María López', equipo: 'Laptop Lenovo',      modelo: 'S310',       serie: 'SN456', descripcion: 'Pantalla rota.',           fechaIngreso: '21/05/2026', plazo: '26/05/2026', recepcionada: true  },
